...
| `src/ui/app/i18n.tsx`                 | Models-screen helper copy loses the ELO-next-step sentence: EN "This model will be your opponent."; RU «Эта модель будет вашим соперником.» `step_elo` key remains.                                                                                                                                                                                                                                                                                   |
