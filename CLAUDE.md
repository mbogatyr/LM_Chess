...
tools/prompt-lab/  # standalone move-prompt evaluation harness (sample/eval/race/compare), run via vite-node; committed 1000-position benchmark generated from karpov.pgn — see docs/superpowers/specs/2026-08-10-prompt-lab-design.md
```
